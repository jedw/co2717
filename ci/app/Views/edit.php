...
<header>
    ...
    <ul>
            ...
            <li class="menu-item hidden"><a href="<?php echo site_url();?>">Home</a></li>
            <li class="menu-item hidden"><a href="<?php echo site_url('/student/all');?>">View Records</a>
            </li>
            <li class="menu-item hidden"><a href="<?php echo site_url('/student/new');?>">New Record</a></li>
        </ul>
    </div>
...
<section>
        <h1>Edit: </h1>
    <form method="post" name="frmAdd" action="<?php echo site_url('student/edit/'.$student['id']);?>">
        <label for="Fname">First Name:</label> <br>
        <input class="form-control" type="text" name="Fname" id="Fname" value="<?php echo $student['first_name']; ?>"><br>

        <label for="Lname">Last Name:</label><br>
        <input class="form-control" type="text" name="Lname" id="Lname" value="<?php echo $student['last_name']; ?>"><br>

        <label for="Address">Address:</label><br>
        <textarea class="form-control" name="Address" id="Address" rows="4" cols="16" ><?php echo $student['address']; ?></textarea> <br>

        <label for="Email">Email Address:</label><br>
        <input class="form-control" type="text" name="Email" id="Email" value="<?php echo $student['email'];?>"> <br>

        <label for="Mobile">Mobile No:</label><br>
        <input class="form-control" type="text" name="Mobile" id="Mobile" value="<?php echo $student['mobile']; ?>"> <br>
