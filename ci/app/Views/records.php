...
<div class="container">
    ...
    <table  class="table table-striped">
        ...
        <tr>
            ...
            <td><a href="<?php echo site_url('student/edit/'.$student['id']);?>" class="btn btn-success">Edit</a>&nbsp;<a href="<?php echo site_url('student/delete/'.$student['id']);?>" class="btn btn-danger">Delete</a></td>
        </tr>
        <?php
        }
        ?>
