...
<header>
    ...
    <ul>
            ...
            <li class="menu-item hidden"><a href="<?php echo site_url('/Home/records');?>">View Records</a>
            </li>
            <li class="menu-item hidden"><a href="<?php echo site_url('/Home/create');?>">New Record</a></li>
        </ul>
    </div>
